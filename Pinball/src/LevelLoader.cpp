...
/// <summary>
/// @brief Extracts the initial screen position for the player ball.
/// this function is called by:
///	
///			levelNode["ball"] >> level.m_ball;
/// 
/// the function is used to set the position of the ball.
/// it kinda reads right to left.
/// the 'x' coord, a part of 'position' which is found in the tankNode
/// is assigned to the ball's position variable.
/// 
/// </summary>
/// <param name="tankNode">A YAML node</param>
/// <param name="tank">A simple struct to store data related to the player ball</param>
////////////////////////////////////////////////////////////
...
/// 
/// Invokes other functions to extract the background, obstacle and ball data.
...
void operator >> (const YAML::Node& levelNode, LevelData& level)
{
	...
	levelNode["ball"] >> level.m_ball; //calls the position function for ball

	//obstacle loading
	const YAML::Node& obstaclesNode = levelNode["obstacle"].as<YAML::Node>();
...
{
	std::stringstream ss;
	ss << ".\\resources\\levels\\LevelOne.yaml";  // NB path
